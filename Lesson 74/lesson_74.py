...
Original file is located at
    https://colab.research.google.com/drive/1IMk42Ogu5tCMXuZ4uah02qlAdBfr97Fq
...
df_tesla.sort_values('TSLA_USD_CLOSE').head()
...
<li>What are the column names? </li>
  <ol>
    <li>MONTH, TSLA_WEB_SEARCH, TSLA_USD_CLOSE</li>
    <li>MONTH, BTC_NEWS_SEARCH</li>
    <li>DATA, CLOSE, VOLUME</li>
    <li>MONTH, UE_BENEFITS_WEB_SEARCH, UNRATE</li>
  </ol>
  <br>
...
print(f'Largest value for Tesla in Web Search: 498,32007')
print(f'Smallest value for Tesla in Web Search: 3.896')

df_tesla.describe()

"""### Unemployment Data"""

df_unemployment.sort_values('UE_BENEFITS_WEB_SEARCH', ascending=False).head()
...
df_btc_search.sort_values('BTC_NEWS_SEARCH', ascending=False).head()
